...
def main():
    ...
    def test_sales_import_integration(self):
        ...
        2. Test Customer Import with Sales Data:
           - Import a customer with sales information to test if sales records are created
           - Sample CSV data:
             name,care_of,mobile,address,brand,model,color,vehicle_number,chassis_number,engine_number,nominee_name,relation,age,sale_amount,payment_method,hypothecation,sale_date,invoice_number
        ...
        3. Dashboard Statistics Testing:
           - Test GET /api/dashboard/stats to verify enhanced sales statistics
           - Verify response includes sales_stats object with:
             - total_sales, direct_sales, imported_sales
             - total_revenue, direct_revenue, imported_revenue
        
        4. Sales Records Verification:
           - Test GET /api/sales to verify imported sales appear in sales collection
           - Check that imported sales have source="import" field
           - Verify sales data includes proper customer and vehicle information
        
        5. Data Integration Testing:
           - Verify imported customers appear in customer list
           - Check if associated vehicles are created/linked properly
           - Test that sales reports can access both direct and imported sales
        
        Focus on ensuring imported sales data is properly integrated into the sales overview and reporting system,
        and that the dashboard correctly shows the breakdown between direct and imported sales.
        """
        print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "comprehensive":
            ...
            print(f"   Success Rate: {(tester.tests_passed/tester.tests_run)*100:.1f}%")
            sys.exit(0 if success else 1)
        elif sys.argv[1] == "unified_schema":
            print("🚀 UNIFIED DATA SCHEMA IMPLEMENTATION TESTING")
            print("=" * 60)
            tester = TwoWheelerAPITester()
            success, results = tester.test_unified_data_schema_implementation()
            print("\n" + "=" * 60)
            print(f"📊 Final Test Results:")
            print(f"   Tests Run: {tester.tests_run}")
            print(f"   Tests Passed: {tester.tests_passed}")
            ...
            print(f"   Success Rate: {(tester.tests_passed/tester.tests_run)*100:.1f}%")
            sys.exit(0 if success else 1)
        elif sys.argv[1] == "import_visibility":
            print("🚀 IMPORT DATA VISIBILITY TESTING")
            print("=" * 60)
            tester = TwoWheelerAPITester()
            success, results = tester.test_import_data_visibility()
            print("\n" + "=" * 60)
            print(f"📊 Final Test Results:")
            print(f"   Tests Run: {tester.tests_run}")
            print(f"   Tests Passed: {tester.tests_passed}")
            ...
            print(f"   Success Rate: {(tester.tests_passed/tester.tests_run)*100:.1f}%")
            sys.exit(0 if success else 1)
        elif sys.argv[1] == "final_comprehensive":
            print("🚀 FINAL COMPREHENSIVE IMPORT FIXES TESTING")
            print("=" * 60)
            tester = TwoWheelerAPITester()
            success, results = tester.test_final_comprehensive_import_fixes()
            print("\n" + "=" * 60)
            print(f"📊 Final Test Results:")
            print(f"   Tests Run: {tester.tests_run}")
            print(f"   Tests Passed: {tester.tests_passed}")
        ...
        elif sys.argv[1] == "spare_part_inventory":
