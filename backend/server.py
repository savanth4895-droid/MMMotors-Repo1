...
async def download_import_template(
    ...
    templates = {
        ...
        "vehicles": "brand,model,chassis_number,engine_number,color,vehicle_number,key_number,inbound_location,page_number,status\nTVS,Apache RTR 160,ABC123456789,ENG987654321,Red,KA01AB1234,KEY001,Warehouse A,Page 1,available\nBAJAJ,Pulsar 150,DEF123456789,ENG987654322,Blue,KA02CD5678,KEY002,Warehouse B,Page 2,available",
