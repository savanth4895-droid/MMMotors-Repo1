...
async def download_import_template(
    ...
    templates = {
        ...
        "services": "customer_name,customer_mobile,vehicle_number,chassis_number,service_type,description,amount\nJohn Doe,9876543210,KA01AB1234,ABC123456789,periodic_service,General servicing,1500.00\nJane Smith,9876543211,KA02CD5678,DEF123456789,repair,Brake repair,800.00"
    }
